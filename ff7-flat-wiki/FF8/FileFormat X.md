...
[Home](/ff7-flat-wiki/Main%20Page.md) > [FF8](/ff7-flat-wiki/FF8.md) > FileFormat X
...
` A=1 B=2 C=6 D=7`
  ...
  [List of battle stages]: /ff7-flat-wiki/FF8/BS%20list.md "wikilink"
  [Click me for battle stage pointer list]: /ff7-flat-wiki/FF8/BattleStage/Pointers.md
    "wikilink"
