...
[Home](../Main Page.md) > [FF7](../FF7.md) > Attack data
...
|--------|-----------------------------------|-----------------------------------------------------------------------------------------------------|
| 0x00   | 1 byte                            | Attack %                                                                                            |
| 0x01   | 1 byte                            | [Impact Effect Id](Battle/Impact Effect Id List.md)                                     |
| 0x02   | 1 byte                            | Target Hurt Action Index                                                                            |
| 0x03   | 1 byte                            | Unknown                                                                                             |
| 0x04   | 2 byte                            | Casting cost                                                                                        |
| 0x06   | 2 bytes                           | [Impact Sound](Battle/Sound Effect Id List.md)                                          |
| 0x08   | 2 bytes                           | [Camera Movement Id](Battle/Camera Movement Id List?redlink=1.md) for single target.    |
| 0x0A   | 2 bytes                           | [Camera Movement Id](Battle/Camera Movement Id List?redlink=1.md) for multiple targets. |
...
| 0x14   | 4 bytes                           | [Status](Battle/Status Effects.md)                                                      |
| 0x18   | 2 bytes                           | [Element](Battle/Elemental Data.md)                                                     |
