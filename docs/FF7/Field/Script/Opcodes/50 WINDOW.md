...
[Home](/Main%20Page.md) > [FF7](/FF7.md) > [Field](/FF7/Field.md) > [Script](/FF7/Field/Script.md) > [Opcodes](/FF7/Field/Script/Opcodes.md) > 50 WINDOW
...
`if (y + h + MIN_WINDOW_DISTANCE > GAME_HEIGHT) { y = GAME_HEIGHT - h - MIN_WINDOW_DISTANCE }`
  ...
  [dialog]: /FF7/Field/Script/Opcodes/40%20MESSAGE.md "wikilink"
  [choices]: /FF7/Field/Script/Opcodes/48%20ASK.md "wikilink"
