...
[Home](../../../../Main Page.md) > [FF7](../../../../FF7.md) > [Field](../../../Field.md) > [Script](../../Script.md) > [Opcodes](../Opcodes.md) > 58 STITM
...
-   **const UShort** *T*: [Type of item](../Item ID.md) to add, or source address to retrieve item type from.
