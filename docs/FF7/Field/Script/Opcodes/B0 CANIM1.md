...
[Home](../../../../Main Page.md) > [FF7](../../../../FF7.md) > [Field](../../../Field.md) > [Script](../../Script.md) > [Opcodes](../Opcodes.md) > B0 CANIM1
...
Exactly the same as [ANIME2](AE ANIME2.md), but allow set first and last frame of given animation.
