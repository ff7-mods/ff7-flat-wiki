...
[Home](../Main Page.md) > [FF7](../FF7.md) > Command data
...
|  0x01  | 1 byte  | [Target Flags](Battle/Targeting Data.md)                                      |
|  0x02  | 2 bytes | Unknown (Always \[FFFFh\])                                                                |
|  0x04  | 2 bytes | [Camera Movement Id](Battle/Camera Movement Id List.md) for single target.    |
|  0x06  | 2 bytes | [Camera Movement Id](Battle/Camera Movement Id List.md) for multiple targets. |
