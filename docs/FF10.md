...
-   [Game data storage](FF10/Game data storage (Steam).md)
...
-   [VBF data archive](FF10/FileFormat VBF.md)

### Universal game files

-   [Kernel data files](FF10/FileFormat Kernel.md)
