...
|--------|------|----------------------------------------------------------------------------------------|------------------------------------------|
| UInt16 | 2    | [Offset](#msg)                                                              | Text Offset (little-endian)              |
...
| Type   | Size | Value                                                                                 | Description                             |
|--------|------|---------------------------------------------------------------------------------------|-----------------------------------------|
| UInt16 | 2    | [Offset](#m003.msg)                                                        | Text Offset (little-endian)             |
| Byte   | 1    | Received                                                                              | Amount received                         |
| UInt16 | 2    | UNK                                                                                   | {0x0001}                                |
| Byte   | 1    | [Input\_Item\_ID](http://forums.qhimm.com/index.php?topic=17034.msg242332#msg242332)  | Input: Item id value **0x00**-**0xC6**  |
| Byte   | 1    | Required                                                                              | Amount needed                           |
...
| Type   | Size | Value                                                                         | Description                     |
|--------|------|-------------------------------------------------------------------------------|---------------------------------|
| UInt16 | 2    | [Offset](#m004.msg)                                                | Text Offset (little-endian)     |
| Byte   | 1    | Received                                                                      | Amount received                 |
| UInt16 | 2    | UNK                                                                           | {0x0001}                        |
...
Text offsets are in [bin](#bin) files. Strings end with **0x00**. [Strings are encoded](String_Encoding.md).
