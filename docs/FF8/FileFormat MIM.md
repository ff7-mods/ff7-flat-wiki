...
[Home](../Main Page.md) > [FF8](../FF8.md) > FileFormat MIM
...
The image contained in the MIM file is just a jumble of 16x16 tiles, to draw them properly you have to read the tile data from the [.map](FileFormat MAP.md) file.
