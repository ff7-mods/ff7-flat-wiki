...
[Home](../Main Page.md) > [FF8](../FF8.md) > FileFormat MAG t
...
To know, how to find out if the given file is texture, please reffer to [MAGfiles\_Generic](FileFormat magfiles.md)
